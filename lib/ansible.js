...
AbstractAnsibleCommand.prototype.extraParams = function(extraParams) {
...
AbstractAnsibleCommand.prototype.addExtraParams = function(commandParams) {
  if (this.config.extraParams) {
    commandParams = commandParams.concat(this.config.extraParams);
  }
  return commandParams;
};
...
AbstractAnsibleCommand.prototype.commonCompileParams = function(commandParams) {
  ...
  commandParams = this.addExtraParams(commandParams);
  return commandParams;
};
